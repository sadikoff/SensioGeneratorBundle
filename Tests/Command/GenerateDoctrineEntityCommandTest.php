...
class GenerateDoctrineEntityCommandTest extends GenerateCommandTest
{
    ...
    public function getNonInteractiveCommandData()
    {
        return array(
            array(array('entity' => 'Blog/Post'), array('Blog\\Post', 'annotation', array())),
            array(array('entity' => 'Blog/Post', '--format' => 'yml', '--fields' => 'created_by:string(255) updated_by:string(length=128 nullable=true) description:text rating:decimal(precision=7 scale=2)'), array('Blog\\Post', 'yaml', array(
